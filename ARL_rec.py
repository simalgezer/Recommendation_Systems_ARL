#Importing Libraries, Functions, and Cleaning Data
import pandas as pd
...
# Data preprocessing for the dataset Online retail II 
...
#Getting rid of the shipping fee
df = df.loc[(df["StockCode"] != "POST")]


#Applying Apriori Function for German Customers
...
def create_rules(dataframe, country = "France"):
...
#Finding the Description (Product Name) of an Item in the Basket
...
#Making a Product Recommendation for Customers at the Basket Stage
